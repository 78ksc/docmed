...
class Appoint(models.Model):
    ...
    alloted_docto = models.ForeignKey('doc.Doctor', on_delete=models.SET_NULL, null=True)

class DocAppoint(models.Model):
    booker = models.ForeignKey(Client, on_delete=models.DO_NOTHING, null=True, blank=True)
    doctor = models.ForeignKey('doc.Doctor', on_delete=models.DO_NOTHING, null=True, blank=True)
